...
gulp.task("css", () => {
    return gulp.src([
        'bootstrap/dist/css/**','bootstrap/dist/fonts/**'
    ], { cwd: "node_modules/**" }) /* Glob required here. */
...
gulp.task('uploadedImg', () =>
    gulp.src('client/uploads/*')
        .pipe(imagemin())
        .pipe(gulp.dest('dist/client/'))
);
/**
...
//gulp.task("build", function (callback) {
  //  runSequence('clean', 'build:server', 'build:client', 'clientResources', 'serverResources', 'libs', 'frontlibs', 'css', 'imgs', callback);
//});
...
gulp.task('default', function () {
    runSequence( 'build:server', 'build:client', 'clientResources', 'serverResources', 'libs', 'frontlibs', 'css', 'watch', 'start');
});
